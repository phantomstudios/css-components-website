---
title: CLI
description: How CSS Components automatically generate components.
category: Advanced
index: 31
---
...
If the tool is installed, run the tool just run:
...
For each style declaration, at a minimum you need to specify both the element type a class name.
...
You can add variants to your component by suffixing the class name. The example below creates a component with `primary` and `theme` variants:
