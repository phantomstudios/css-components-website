...
However, there are times when you do indeed wish to pass a prop down element, either to be visible on the DOM, or used by a composed component. This is where `passthrough` comes in.
